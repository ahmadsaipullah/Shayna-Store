                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel :items-to-show="1" class="product-thumbs-track ps-slider">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link class="primary-btn pd-cart" :to="{name:'card'}">Add To Cart</router-link> 
                                </div>
                            </div>
                        </div>
                    </div>
...
import RelateShyna from '@/components/RelateShyna.vue';
